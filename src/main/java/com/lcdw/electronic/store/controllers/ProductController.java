...
//    /products/live
    ...
    public ResponseEntity<ImageResponse> uploadProductImage(
       ...
       ProductDto updatedProduct=productService.update(productDto,productId);
        ImageResponse imageResponse =ImageResponse.builder().ImageName(updatedProduct.getProductImageName()).success(true).message("image is uploaded succesfully ").status(HttpStatus.CREATED).build();
